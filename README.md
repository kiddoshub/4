...
The [HVH targeting sample](hvh_targeting/README.md) is a separate Windows C++ project based on the memory layout supplied in the task. It includes configurable offsets and math tests. Its example offsets are unverified and must be replaced with the exact layout of the user's own game.
